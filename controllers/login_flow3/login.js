...
exports.authLogin_driller = async (req,res) =>{
    const {user,password} = req.body
    try{
        const [result] = await pool.pool.execute(`SELECT * FROM login_user WHERE user="${user}" AND password="${password}" AND  page="driller"`)
